# API Contracts: Digital Twin Simulation Educational Module
...
- **Description**: Returns content related to specific simulation concepts
- **Method**: GET
- **Path**: `/api/search/concept`
- **Parameters**: 
  - concept (query, required): The simulation concept to search for
- **Response Codes**:
