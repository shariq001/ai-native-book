# API Contracts: ROS 2 Nervous System Educational Module
...
- **Description**: Returns content related to specific ROS 2 concepts
- **Method**: GET
- **Path**: `/api/search/concept`
- **Parameters**: 
  - concept (query, required): The ROS 2 concept to search for
- **Response Codes**:
