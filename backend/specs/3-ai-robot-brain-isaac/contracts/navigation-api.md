# API Contracts: AI-Robot Brain Educational Module
...
- **Description**: Returns content related to specific AI/robotics concepts
- **Method**: GET
- **Path**: `/api/search/concept`
- **Parameters**: 
  - concept (query, required): The AI/robotics concept to search for
- **Response Codes**:
