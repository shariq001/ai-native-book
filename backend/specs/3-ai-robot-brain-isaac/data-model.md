# Data Model: AI-Robot Brain Educational Module
...
- **Title**: "AI-Robot Brain Educational Module" (string, required)
- **Description**: Educational content explaining AI navigation concepts using NVIDIA Isaac (string, required)
- **TargetAudience**: "AI Developers & Roboticists" (string, required)
...
- **ArchitecturePattern**: The conceptual architecture pattern ("Perception-Planning-Action" loop) (string, required)
...
- **ConceptsCovered**: List of AI/robotics concepts covered in the chapter (array of strings, required)
...
- **SectionFlow**: The position in the sequential flow (Data Generation → Localization → Planning → Bipedal) (string, required)

### VisualElement
- **ID**: Unique identifier for the visual element (string, required)
- **ChapterID**: Reference to parent chapter (string, required)
- **Type**: Category of visual ("2D Flowchart", "SVG Diagram", "Mermaid Chart", "Static Visualization") (string, required)
...
- **Topic**: The specific topic the visual relates to (e.g., "Costmap visualization", "VSLAM landmark recognition") (string, required)
...
- **Background**: Technical background ("AI Developer", "Roboticist", etc.) (string, optional)
...
- ArchitecturePattern must be "Perception-Planning-Action" loop
...
- SectionFlow must be one of: "Data Generation", "Localization", "Planning", "Bipedal"
